...
async function fetchOne(구분, jobInfo, files) {
  const prompt=`당신은 산업안전보건법 전문 위험성평가사입니다. 아래 작업의 [${구분}] 위험요인을 분석하여 수시 위험성평가를 작성하세요.
작업명: ${jobInfo.작업명} / 소속: ${jobInfo.소속} / 작성사유: ${jobInfo.작성사유}
추가설명: ${jobInfo.추가정보||"없음"}

## 빈도(가능성) 판단 기준
- 상=3: 1개월에 1회 정도 발생 예상 / 안전장치·안전수칙·표지 없음
- 중=2: 1년에 1회 정도 발생 예상 / 안전장치 있으나 해제·무시 가능성 있음
- 하=1: 3년에 1회 정도 발생 예상 / 방호덮개·안전장치 충분히 설치되어 있음

## 강도(중대성) 판단 기준
- 대=3: 사망·실명·장애 초래 가능 / 화학물질 노출기준 50% 초과 / 발암성·변이원성 물질 / 직업병
- 중=2: 완치 가능한 상해 / 의료기관 치료 필요 / 화학물질 노출기준 10~50%
- 소=1: 아차사고 수준 (의료 처치 불필요) / 화학물질 노출기준 10% 이하

## 판정 및 작성 규칙
- 위험도 = 빈도 × 강도 (1~9점)
- 해당 없음: 주요위험요인="해당 없음", 나머지="-", 빈도=1, 강도=1
- 위험도 1~2: 개선대책="-", 개선후=개선전 동일
- 위험도 3~4: 안전보건대책 수립 필요 → 구체적 개선대책 작성
- 위험도 6~9: 즉시 개선 필요 → 강력한 개선대책 작성
- 주요위험요인·현재안전조치·개선대책은 해당 작업의 특성에 맞게 구체적으로 작성 (일반적 표현 지양)
- 첨부파일 있으면 내용을 적극 참고하여 위험요인 정확히 도출

## 출력: JSON 객체만 (백틱·설명 금지, 문자열 내 큰따옴표→작은따옴표)
{"구분":"${구분}","주요위험요인":"...","현재안전조치":"...","개선대책":"...","개선전":{"빈도":1,"강도":1},"개선후":{"빈도":1,"강도":1}}`;
